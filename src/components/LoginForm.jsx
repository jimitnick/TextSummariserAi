...
import loginBackground from "../textsummariserBackground.png"
const LoginForm = () => {
  ...
  return (
    <div className={`h-screen w-screen flex justify-center items-center`}>
      ...
      <div className='w-full h-full backdrop-blur-[6px] absolute'></div>
        <div className="md:w-full max-w-sm bg-zinc-800 shadow-white  p-6 rounded-lg shadow-md  md:h-[500px] flex flex-col justify-center gap-16 z-1">
